                ...
                <form method="post" action="{{ route('newregister.update', $newregister->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                            ...
                            <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                ...
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        ...
                                        <input {{ $vocabulary }} id="horizontal-list-radio-license" type="radio" value="vocabulary" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                ...
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        ...
                                        <input {{ $expression }} id="horizontal-list-radio-id" type="radio" value="expression" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                ...
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        ...
                                        <input {{$contractions}} id="horizontal-list-radio-millitary" type="radio" value="contractions" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="note" id="note" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('note', $newregister->note) }}" />
                            @error('note')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
