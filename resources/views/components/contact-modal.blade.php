<a href="#" onclick="ShowModalContact('myModalContact')" class="fixed bottom-4 right-4 text-sm bg-green-500 border-2 border-white shadow-lg hover:bg-green-600 text-white px-2 py-1 rounded-full ml-2 flex items-center">
            ...
            <div class="bg-white p-4">
                <form action="{{ route('contact.save') }}" method="post">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <button type="button" onclick="HiddenModalContact('myModalContact')" class="px-3 py-2 bg-gray-500 text-white rounded-full hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-md mr-4">
                            <i class="fa fa-ban"></i> Cancel
                        </button>

                        <button type="submit" class="px-3 py-2 bg-violet-500 text-white rounded-full hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-violet-300 text-md mr-4">
