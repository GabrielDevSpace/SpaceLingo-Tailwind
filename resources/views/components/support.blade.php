            ...
            <div class="w-full">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-center">
                        ...
                        <div>
                            <button class="bg-purple-700 hover:bg-purple-900 text-white text-xs px-2 py-1 rounded-full flex items-center" onclick="copyToClipboard('key_pix')"><i class="fa fa-copy"></i>Copy</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center">
                    <div class="p-4">
                        ...
                        <div class="flex justify-center">
                            ...
                            <div>
                                <button class="bg-purple-700 hover:bg-purple-900 text-white text-xs px-2 py-1 rounded-full flex items-center" onclick="copyToClipboard('address_bitcoin')"><i class="fa fa-copy"></i>Copy</button>
                            </div>
                        </div>
                    </div>
                </div>
